...
<html>
	...
	<body>
		...
		<div id="button1">
			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1">Cambiar incidencia</button>
					...
					<div class="modal-content">
						<div class="modal-body">
							<div class="column" id="main">
								<form method="post" method="post" action="IncidenciaCl.php?cosa=<?php echo urlencode($email); ?>">
