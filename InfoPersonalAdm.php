...
<html>
	...
	<body>
							...
							<div class="column" id="main">
								<form method="post" method="post" action="GestionUserAdm.php?cosa=<?php echo urlencode($email); ?>">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="InputDate1" id="InputDate1" aria-describedby="emailHelp" placeholder="Identificador">
									</div>
									<button name="AnyaHacRes" type="submit" class="btn btn-primary">Eliminar cliente</button>
								</form>
							</div>
						</div>
					</div>
		...
		<div id="button1">
			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal6">Crear trabajador</button>
			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal6">Eliminar trabajador</button>
		</div>
	</body>
