...
<html>
	...
	<body>
		...
		<?php
			...
			$sql = "SELECT Nom, Direccio, NumTelefon, NomPrograma FROM adquireixprog INNER JOIN clients ON clients.IDClient = adquireixprog.IDPrograma INNER JOIN programes ON programes.IDPrograma = adquireixprog.IDPrograma";
